...
class Matrix : public util::Operators<Matrix<value_t, rows, cols, arena_e>> {
  ...
  using Mat = Matrix<value_t, rows, cols, arena_e>;
  using MatTranspose = Matrix<value_t, cols, rows, arena_e>;
  using InputVec = Vec<value_t, cols, arena_e>;
  using OutputVec = Vec<value_t, rows, arena_e>;
 ...
 */
template <typename value_t, size_t rows, size_t cols, ArenaType arena_e>
[[nodiscard]] constexpr auto Matrix<value_t, rows, cols, arena_e>::transpose()
    const -> MatTranspose
{
  MatTranspose result{};
 ...
 */
template <typename value_t, size_t rows, size_t cols, ArenaType arena_e>
[[nodiscard]] auto Matrix<value_t, rows, cols, arena_e>::random() -> Mat
{
  Mat result{};
 ...
 */
template <typename value_t, size_t rows, size_t cols, ArenaType arena_e>
constexpr auto Matrix<value_t, rows, cols, arena_e>::operator+(
